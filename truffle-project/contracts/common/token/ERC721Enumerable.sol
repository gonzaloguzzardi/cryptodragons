...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
	 ...
	 */
	function supportsInterface(bytes4 interfaceId) public virtual override(IERC165, ERC721) view returns (bool) {
	...
	function tokenByIndex(uint256 index) public virtual override view returns (uint256) {
		require(index < ERC721Enumerable.totalSupply(), 'Index out of bounds');
