...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
	 ...
	 */
	function supportsInterface(bytes4 interfaceId) public virtual override(ERC165, IERC165) view returns (bool) {
		return
	...
	function approve(address to, uint256 tokenId) public virtual override {
		...
		require(_msgSender() == owner || isApprovedForAll(owner, _msgSender()), 'Not owner');
